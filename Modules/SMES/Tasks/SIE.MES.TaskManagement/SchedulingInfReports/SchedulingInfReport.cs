...
namespace SIE.MES.TaskManagement.SchedulingInfReports
{
    ...
    [Label("排程状态查询表")]
    public class SchedulingInfReport : ViewModel
    {
        ...
        /// </summary>
        [Label("MRP 控制者")]
        public static readonly Property<string> MrpProperty = P<SchedulingInfReport>.Register(e => e.Mrp);
        ...
        /// </summary>
        [Label("产线名称")]
        public static readonly Property<string> MachineNameProperty = P<SchedulingInfReport>.Register(e => e.MachineName);
        ...
        /// </summary>
        [Label("计划开始时间")]
        public static readonly Property<DateTime> PlanBeginDateProperty = P<SchedulingInfReport>.Register(e => e.PlanBeginDate);
        ...
        /// </summary>
        [Label("计划完成时间")]
        public static readonly Property<DateTime> PlanEndDateProperty = P<SchedulingInfReport>.Register(e => e.PlanEndDate);
