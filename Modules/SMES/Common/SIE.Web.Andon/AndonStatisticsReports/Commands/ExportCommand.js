SIE.defineCommand('SIE.Web.Andon.AndonStatisticsReports.Commands.ExportMixCommand', {
    extend: 'SIE.Web.Andon.AndonStatisticsReports.Commands.ExportCommandBase',
    ...
    getExportInfo: function (view) {
        ...
        var rateChart = Ext.getCmp("andonRateChartId");//Ext.getCmp("edoRateChartId");
        var ngListView = esdMainPanel._gListView;
        var gridData = me.getGridData(ngListView);//数据列表
        var pictures = [];
